...
class ICMPSocket(object):
    ...
    def __init__(self, incoming_queue: asyncio.Queue):
        ...
        self.sendto(self.MINIMAL_PACKET, self.DEFAULT_DESTINATION)  # need to send one packet, because didnt bind. otherwise exception is raised when using on first packet.
