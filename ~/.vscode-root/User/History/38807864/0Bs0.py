...
class TunnelEndpoint:
    ...
    async def handle_incoming_from_icmp_channel(self):
        ...
        while True:
            ...
            actions = {
                Packet.Action.start: self.handle_start_request,
                Packet.Action.end: self.handle_end_request,
                Packet.Action.data: self.handle_data_request,
                Packet.Action.ack: self.handle_ack_request,
            }
    ...
    async def wait_for_stale_connection(self):
        ...
        while True:
            ...
            new_tunnel_packet = Packet(client_id=client_id, operation=Packet.Action.end, direction=self.direction)
    ...
    async def send_icmp_packet_and_wait_for_ack(self, tunnel_packet: Packet):
        """
