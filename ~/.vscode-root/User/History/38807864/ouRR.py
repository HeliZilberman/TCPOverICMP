...
class TunnelEndpoint:
    ...
    async def handle_incoming_from_icmp_channel(self):
        ...
        while True:
            ...
            actions = {
                ...
                Packet.Operation.end: self.handle_end_request,
                Packet.Operation.data: self.handle_data_request,
    ...
    async def handle_incoming_from_tcp_channel(self):
        ...
        while True:
            ...
            new_tunnel_packet = Packet(
                client_id=client_id,
                seq=seq,
                operation=Packet.Operation.data,
    ...
    async def wait_for_stale_connection(self):
        ...
        while True:
            ...
            new_tunnel_packet = Packet(client_id=client_id, operation=Packet.Operation.end, direction=self.direction)
